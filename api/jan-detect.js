    ...
    const response = await client.messages.create({
      ...
      messages: [{
        ...
        content: [
          ...
          {
            type: 'text',
            text: 'この画像に写っているバーコード（JAN/EAN-13/ISBN/EAN-8）を1つ読み取り、13桁または8桁の数字だけを返してください。'
              + '本・書籍が写っている場合は978または979から始まるISBNコードを最優先してください。'
              + '192で始まる13桁のコード（例：1920000000000）は価格・分類コードのため絶対に返さないでください。'
              + '画像が逆さまや傾いていても、バーコードの数字を正しい読み取り順序で返してください（逆順・反転禁止）。'
